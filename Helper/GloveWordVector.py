...
class GloveWordVector():
    ...
    def __init__(self, path, dir=True, dimension=100, glove_file_path=False, save_model_path=False,
        ...
        if glove_file_path:
            ...
            self.glove_vocab_file = '/home/sumitrathore1313/apps/django/django_projects/Project/data/Test/vocab.txt'
        else:
            self.glove_file = '/home/sumitrathore1313/glove/glove.6B.300d.txt'
            self.glove_vocab_file = '/home/sumitrathore1313/apps/django/django_projects/Project/data/Test/vocab.txt'
        if dir:
